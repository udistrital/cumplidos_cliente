...
angular.module('contractualClienteApp')
  .controller('AprobacionCoordinadorCtrl', function (homologacionDependenciaService, oikosRequest, $http, uiGridConstants, contratoRequest, $translate, administrativaRequest, academicaWsoService, coreRequest, $q, $window, $sce, gestorDocumentalMidRequest, adminMidRequest, $routeParams, utils) {
