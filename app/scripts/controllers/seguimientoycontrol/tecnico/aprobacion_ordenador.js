...
angular.module('contractualClienteApp')
  .controller('AprobacionOrdenadorCtrl', function (token_service, $scope, $http, uiGridConstants, contratoRequest, $translate, utils, documentoRequest, gestorDocumentalMidRequest, $q, $sce, $window, gridApiService,  adminJbpmV2Request, cumplidosCrudRequest, cumplidosMidRequest, notificacionRequest) {
