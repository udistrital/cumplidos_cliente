...
angular.module('contractualClienteApp')
  .controller('AprobacionSupervisorCtrl', function (token_service, funcGen, $sessionStorage, $scope, $http, $translate, uiGridConstants, contratoRequest, gestorDocumentalMidRequest, $q, documentoRequest, $window, $sce, utils, $routeParams, notificacionRequest, amazonAdministrativaRequest, cumplidosMidRequest, cumplidosCrudRequest) {
